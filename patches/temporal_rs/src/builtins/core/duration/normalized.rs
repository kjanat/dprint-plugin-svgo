...
use crate::{
  Calendar, NS_PER_DAY, NS_PER_DAY_NONZERO, NonZeroSign, TemporalError, TemporalResult,
  TemporalUnwrap,
  builtins::{
...
impl InternalDurationRecord {
  ...
  fn nudge_calendar_unit(
    ...
    let total_is_r2 =
      total_times_divisor.div_euclid(divisor) == r2 && total_times_divisor.rem_euclid(divisor) == 0;
