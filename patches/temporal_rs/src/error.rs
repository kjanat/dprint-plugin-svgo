...
impl ErrorMessage {
  pub fn to_string(self) -> &'static str {
    match self {
      ...
      Self::OffsetNeedsDisambiguation => "Offsets could not be determined without disambiguation",
      Self::None => "",
      Self::String(s) => s,
...
pub fn ixdtf_error_to_static_string(error: ParseError) -> &'static str {
  match error {
    ...
    ParseError::AnnotationKeyValueSeparator => "Invalid annotation key-value separator character.",
