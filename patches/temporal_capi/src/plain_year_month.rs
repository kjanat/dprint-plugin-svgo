...
pub mod ffi {
  ...
  impl PlainYearMonth {
    ...
    pub fn to_plain_date(&self, day: Option<PartialDate>) -> Result<Box<PlainDate>, TemporalError> {
      self
        .0
    ...
    pub fn to_ixdtf_string(&self, display_calendar: DisplayCalendar, write: &mut DiplomatWrite) {
