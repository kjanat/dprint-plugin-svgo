...
pub mod ffi {
  ...
  impl ParsedZonedDateTime {
    ...
    pub fn from_utf8_with_provider<'p>(
      ...
      with_provider!(p, |p| {
        temporal_rs::parsed_intermediates::ParsedZonedDateTime::from_utf8_with_provider(s, p)
      })
  ...
  impl ZonedDateTime {
    ...
    pub fn from_parsed(
      ...
      Self::from_parsed_with_provider(parsed, disambiguation, offset_option, &Provider::compiled())
    }
    ...
    pub fn equals(&self, other: &Self) -> bool {
      self
        .equals_with_provider(other, &Provider::compiled())
        .unwrap_or(false)
    }
    ...
    pub fn hours_in_day_with_provider<'p>(&self, p: &Provider<'p>) -> Result<f64, TemporalError> {
    ...
    #[cfg(feature = "compiled_data")]
    pub fn with_plain_time(&self, time: Option<&PlainTime>) -> Result<Box<Self>, TemporalError> {
